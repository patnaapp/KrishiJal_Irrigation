...
import bih.in.krishijal_irrigation.ui.Udvah_Sinchaai_YojnaActivity;


public class UdvahEditAdapter extends RecyclerView.Adapter<UdvahEditAdapter.ViewHolder> {
    ...
    public UdvahEditAdapter(Context context, ArrayList<InspectionDetailsModel> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.adaptor_udvah_sinchai_edit, parent, false);
...
//        });
        ...
        holder.tv_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, Udvah_Sinchaai_YojnaActivity.class);
...
//        });
    ...
    public void setDataToView(InspectionDetailsModel info, ViewHolder holder, int position){
            ...
            holder.tv_jalshrot.setText(info.getWaterSourceName());
            holder.tv_motor_power.setText(info.getMotor_Pump_PowerName());
...
//    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView tv_panchayat,tv_village,tv_command_area,tv_approx_amount,tv_jalshrot,tv_motor_power;
        ...
        ViewHolder(View itemView) {
            ...
            tv_jalshrot = itemView.findViewById(R.id.tv_jalshrot);
            tv_motor_power = itemView.findViewById(R.id.tv_motor_power);
